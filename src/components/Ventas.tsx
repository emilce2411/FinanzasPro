              ...
              return (
                ...
                >
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400 mt-2 font-mono">Costo Unitario Ref: ${prod.cost ? prod.cost.toFixed(2) : "0.00"}</p>
                  </div>

                  <div className="mt-4 pt-4 border-t border-slate-100/70">
                    <button
                      onClick={() => handleAddToCart(prod)}
                      className="w-full flex items-center justify-center gap-1.5 bg-slate-900 hover:bg-slate-850 text-white font-bold py-2 px-4 rounded-xl text-xs transition-colors cursor-pointer"
                    >
                  ...
                  return (
                    ...
                    >
                      <div className="flex-1 min-w-0 pr-2">
                        ...
                        <p className="text-[10px] text-indigo-600 font-mono mt-0.5">${item.product.price.toFixed(2)} c/u</p>
                        
                        {hasNegative && (
                          <span className="inline-flex items-center gap-0.5 text-[9px] text-amber-700 bg-amber-50 font-bold px-1 py-0.5 rounded border border-amber-100 mt-1">
                            <AlertTriangle className="w-2.5 h-2.5 shrink-0" /> Excede stock ({item.product.stock} u. disponible)
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center bg-white border border-slate-200 rounded-lg shadow-sm">
                          <button
                            ...
                            className="p-1 text-slate-500 hover:text-slate-700 hover:bg-slate-50 active:bg-slate-100 rounded-l-lg"
                          >
                          ...
                          <button
                            onClick={() => updateCartQty(item.product.id, 1)}
                            className="p-1 text-slate-500 hover:text-slate-700 hover:bg-slate-50 active:bg-slate-100 rounded-r-lg"
                          >
